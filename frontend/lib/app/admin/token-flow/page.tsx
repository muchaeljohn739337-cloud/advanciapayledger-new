      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-white mb-2">🪙 Advancia Token Flow</h1>
                  ...
                  <EconomicStat
                    ...
                    value={
                      stats?.totalSupply && stats?.totalInCirculation
                        ? `${(
                            (parseFloat(stats.totalInCirculation) / parseFloat(stats.totalSupply)) *
                            100
                          ).toFixed(2)}%`
                        : '0%'
                    }
                  ...
                  <EconomicStat
                    ...
                    value={
                      stats?.totalSupply && stats?.totalLocked
                        ? `${(
                            (parseFloat(stats.totalLocked) / parseFloat(stats.totalSupply)) *
                            100
                          ).toFixed(2)}%`
                        : '0%'
                    }
