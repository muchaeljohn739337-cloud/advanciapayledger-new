...
export default function CodeGeneratorTab() {
  ...
  const { loading, error, result, progress, generateCodeContent, resetState } = useAIGenerator();
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div>
          ...
          <select
            value={model}
            onChange={(e) => setModel(e.target.value as CodeGenerationRequest['model'])}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm text-blue-200">
              <p className="font-medium">
                ...
                {progress.status === 'completed' && 'Code generated successfully!'}
                {progress.message}
              </p>
            </div>
          </div>
